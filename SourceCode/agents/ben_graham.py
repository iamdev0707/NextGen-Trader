...
def ben_graham_agent(state: AgentState):
    ...
    for ticker in tickers:
        ...
        max_possible_score = earnings_analysis["max_score"] + strength_analysis["max_score"] + valuation_analysis["max_score"]
        ...
        graham_analysis[ticker] = graham_output.model_dump()
    ...
    data_update = {
    "analyst_signals": {
        "ben_graham_agent": graham_analysis
    }
}
