...
def aswath_damodaran_agent(state: AgentState):
    ...
    data_update = {
    "analyst_signals": {
        "aswath_damodaran_agent": damodaran_signals
    }
}
...
# Helper analyses
# ────────────────────────────────────────────────────────────────────────────────
def analyze_growth_and_reinvestment(metrics: list, line_items: list,progress_callback: callable = None) -> dict[str, any]:
    """
    Growth score (0-4):
...
def analyze_risk_profile(metrics: list, line_items: list,progress_callback: callable = None) -> dict[str, any]:
    """
    Risk score (0-3):
      +1  Beta < 1.3
      +1  Debt/Equity < 1
...
def analyze_relative_valuation(metrics: list,progress_callback: callable = None) -> dict[str, any]:
    """
...
# ────────────────────────────────────────────────────────────────────────────────
def calculate_intrinsic_value_dcf(metrics: list, line_items: list, risk_analysis: dict,progress_callback: callable = None) -> dict[str, any]:
    """
    FCFF DCF with:
