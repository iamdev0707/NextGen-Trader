...
class Position(BaseModel):
    long: int = Field(default=0, description="Number of shares held long")
    short: int = Field(default=0, description="Number of shares held short")
    long_cost_basis: float = Field(default=0.0, description="Average cost per share for long position")
    short_cost_basis: float = Field(default=0.0, description="Average price per share for short position")
